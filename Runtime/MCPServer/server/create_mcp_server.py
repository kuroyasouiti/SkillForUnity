    ...
    server = Server(
        ...
        instructions="\n".join(
            [
                ...
                "",
                "C#スクリプト作成時の重要なルール:",
                "- [SerializeField]属性を持つprivate変数を作成する場合は、必ずその値を返すpublic読み取り専用プロパティも作成してください。",
                "- 例: [SerializeField] private int health = 100; の場合、public int Health => health; を追加してください。",
                "- これにより、MCP経由でコンポーネントの状態を検査する際に、SerializedFieldの値も確認できるようになります。",
                "",
