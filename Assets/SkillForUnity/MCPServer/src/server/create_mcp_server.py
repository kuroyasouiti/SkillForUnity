...
def create_mcp_server() -> Server:
    server = Server(
        ...
        instructions="\n".join(
            [
                "# Unity MCP Server v1.8.0 - Quick Reference",
                "Unityプロジェクトと連携するMCPサーバー。21ツール、3層構造（Low/Mid/High-Level）で効率的な開発を実現。",
                "",
                "## 🔴 Critical Rules (必ず守る)",
                ...
                "",
                "### Project Settings",
                "- 読み取り: unity_projectSettings_crud(operation='read', category='player'|'quality'|'time'|'physics'|'audio'|'editor', property='...')",
                "- 書き込み: unity_projectSettings_crud(operation='write', category='...', property='...', value=...)",
                "- タグ追加: unity_projectSettings_crud(operation='addTag', tag='...')",
                "- レイヤー追加: unity_projectSettings_crud(operation='addLayer', layer='...')",
                "",
                "## ⚡ Performance & Best Practices",
                "",
                "### ツール選択ガイド:",
                "1. **ゲームシステム構築** → High-Level GameKit (Actor, Manager, Interaction, UICommand, SceneFlow)",
                "2. **複数オブジェクト処理** → Mid-Level Batch (Transform, RectTransform, Physics, Camera, UI, Audio, Input)",
                ...
                "### バッチ操作（推奨）:",
                "❌ 避ける: ループ内で個別ツール呼び出し",
                "✅ 推奨: Mid-Level Batchツールまたは *Multiple 操作",
                ...
                "例: unity_gamekit_actor, unity_transform_batch, unity_gameobject_crud",
                "",
                "---",
